...
namespace RPGCore.Dialogue.Editor
{
    ...
    {
        //资源保存的路径
        private static readonly string dialogueItemSavePath =
            "Assets/Scripts/Unity-RPGCore-DialogueSystem/Example/ScriptableObjects/Dialogue/Items/";

        private static readonly string dialogueGroupSavePath =
            "Assets/Scripts/Unity-RPGCore-DialogueSystem/Example/ScriptableObjects/Dialogue/Groups/";
        ...
        public static DialogueItemDataSO CreateDialogueItemData(DialogueGroupDataSO groupData, string name,
            string description)
        {
            DialogueItemDataSO itemData = ScriptableObject.CreateInstance<DialogueItemDataSO>();
